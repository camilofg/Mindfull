...
namespace MIndFull 
{
    public class BaseViewModel:INotifyPropertyChanged
    {
        ...
        /*
        private string ficha = string.Empty;
        public const string FichaPropertyName = "Ficha";

        public string Ficha
        {
            get { return ficha; }
            set { SetProperty(ref ficha, value, FichaPropertyName); }
        }
        */
        ...
        protected void SetProperty<T>(ref T backingStore, 
            T value, 
            string propertyName, Action onChanged = null)
        {
